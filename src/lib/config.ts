...
// Single-vertical build: this standalone site is TRT only. The array shape is
// kept (the platform types expect it) but holds just the one vertical, served
// at the domain root.
export const VERTICALS: Vertical[] = [
  { id: "trt", name: "TRT", tagline: "Compare the best online testosterone replacement therapy (TRT) clinics", accent: "#111111" },
];

export const DEFAULT_VERTICAL = "trt";
...
export const PUBLISHED_VERTICALS = ["trt"];
...
// Article slugs kept out of the index. Empty on this single-vertical ED build -
