...
export const metadata: Metadata = {
  ...
  description:
    "FTC disclosure, affiliate relationship details, medical disclaimer, and revenue model transparency for toptrt.io.",
  alternates: {
    canonical: "https://www.toptrt.io/disclaimer",
  },
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        ...
        <p>
          In accordance with the Federal Trade Commission guidelines, Top TRT
        ...
        <p>
          Top TRT participates in affiliate programs with various testosterone
          replacement therapy providers and telehealth platforms. This means we may earn
        ...
        <p>
          The content on Top TRT is for general information purposes only and is not
          intended as medical advice. TRT is a prescription treatment, prescribed and
          monitored by a licensed clinician, that carries potential risks and side effects.
          Always consult with a licensed healthcare professional before making decisions
          about your health or starting any treatment.
        </p>
        ...
        <p>
          Top TRT generates revenue primarily through affiliate commissions.
