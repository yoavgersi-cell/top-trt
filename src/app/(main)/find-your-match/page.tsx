    ...
    return (
      <>
        ...
        <div className="flex min-h-[60vh] items-center justify-center">
          <div className="h-8 w-8 animate-spin rounded-full border-2 border-gray-200 border-t-[#111111]" />
        </div>
      </>
    );
  }
    ...
    return (
      <><HideChrome /><div className={`flex min-h-[60vh] flex-col items-center justify-center px-6 transition-all duration-[280ms] ease-out ${phaseTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}>
        ...
        <div className="relative flex h-14 w-14 items-center justify-center">
          <div className="absolute inset-0 animate-ping rounded-full bg-[#111111]/10" style={{ animationDuration: "1.5s" }} />
          <div className="absolute inset-0 animate-pulse rounded-full bg-[#111111]/5" style={{ animationDuration: "2s" }} />
          <div className="relative flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#111111] to-[#1a7ab5] shadow-lg">
        ...
        <div className="mt-3 flex items-center gap-1.5">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="h-1.5 w-1.5 rounded-full bg-[#111111]/40 animate-bounce"
      ...
      <><HideChrome /><div className={`flex min-h-[60vh] flex-col items-center pt-20 sm:pt-28 px-6 bg-white transition-all duration-[280ms] ease-out ${phaseTransitioning ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}>
        <div className="flex flex-col items-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-1">
            ...
            <p className="text-[12px] text-gray-400 sm:text-[13px]">men found their TRT provider with us</p>
          </div>
        </div>
      </div></>
    );
        ...
        <div className="mx-auto max-w-[800px] px-4 overflow-hidden">
          ...
          <div className="mb-3">
            <div className="mb-2 flex items-center gap-2 px-1">
              <span className="rounded-full bg-[#111111] px-4 py-1 text-[12px] font-bold text-white sm:text-[13px]">
            ...
            <div className="mt-2 flex items-center gap-3 px-1">
              {featured.reasons.map((r, i) => (
                <span key={i} className="flex items-center gap-1 text-[11px] text-gray-500 sm:text-[12px]">
                  <Check className="h-3 w-3 shrink-0 text-[#111111]" strokeWidth={2} />
                  {r}
                </span>
              ))}
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`flex w-full items-center rounded-xl border-[1.5px] px-4 py-2.5 text-left text-[16px] font-medium transition-all duration-200 sm:px-5 sm:py-3 sm:text-[17px] active:scale-[0.99] ${
                        isSelected
                          ? "border-[#111111] bg-[#111111]/[0.04] text-[#191919] shadow-sm"
    ...
    <div className="mt-4 sm:mt-5">
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className={`w-full rounded-xl border py-2.5 pl-10 pr-4 text-[14px] placeholder-gray-400 focus:border-[#111111] focus:bg-white focus:outline-none sm:py-3 sm:text-[15px] ${
            selected && !search ? "border-[#111111] bg-[#111111]/5 text-[#111111] font-medium" : "border-gray-200 bg-[#fafbfc] text-gray-800"
          }`}
        />
      </div>
      ...
      <div className="max-h-[160px] overflow-y-auto rounded-xl border border-gray-200 bg-white sm:max-h-[200px]">
        {filtered.map((opt) => {
          ...
          return (
            ...
            >
              <MapPin className={`h-3.5 w-3.5 shrink-0 ${isActive ? "text-[#111111]" : "text-gray-300"}`} strokeWidth={1.5} />
              {opt.label}
            </button>
          );
        })}
