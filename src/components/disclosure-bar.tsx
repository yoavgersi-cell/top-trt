    ...
    <>
      <div className="bg-[#f0f4f8] border-b-[1.5px] border-[#cdd7e1] px-4 py-1.5 sm:py-2 text-center text-[10px] sm:text-[13px] leading-tight sm:leading-normal text-gray-600">
        ...
        <button
          ...
          className="font-bold text-[#191919] underline underline-offset-2 hover:text-[#111111]"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setIsOpen(false)}>
          ...
          >
            ...
            <div className="space-y-4 text-[14px] leading-[1.7] text-gray-600">
              <p>
                Top TRT is an independent comparison website designed to help men explore and evaluate testosterone replacement therapy (TRT) providers. We research, review, and compare available programs, services, and treatment options to make the decision process easier.
              </p>
              <p>
