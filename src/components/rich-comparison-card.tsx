...
export function RichComparisonCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      {/* Top ranked ribbon */}
      {product.badge && (
        <div className="flex items-center gap-1.5 bg-[#111111] px-5 py-1.5 text-[12px] font-bold uppercase tracking-wide text-white">
      ...
      <div className="p-4 sm:p-7">
        ...
        <div className="flex flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <div className="text-right">
              ...
              <p className="mt-0.5 text-[10px] font-bold uppercase tracking-wide text-[#111111] sm:text-[11px]">{product.ratingLabel}</p>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg bg-[#111111] px-2.5 py-1 text-white sm:rounded-xl sm:px-3 sm:py-1.5">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:mt-5 sm:gap-5 lg:flex-row lg:items-start">
          ...
          <div className="flex shrink-0 flex-row items-center gap-3 lg:w-[220px] lg:flex-col lg:items-stretch lg:gap-2.5 lg:rounded-xl lg:bg-[#F7F8FA] lg:p-4">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-2 lg:w-full lg:flex-none">
              ...
              <Link
                href={reviewHref}
                className="text-center text-[12.5px] font-semibold text-[#111111] hover:underline"
              >
                Read full review
              </Link>
        ...
        {intro && (
          <div className="mt-4 border-t border-gray-100 pt-3.5 sm:mt-5 sm:pt-4">
            ...
            <Link
              href={reviewHref}
              className="mt-1.5 inline-flex items-center gap-1 text-[12.5px] font-semibold text-[#111111] hover:underline sm:text-[13px]"
            >
