    ...
    <article className="relative rounded-md border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md overflow-hidden">
        ...
        <div className="relative flex flex-col items-center justify-center gap-4 px-6 py-5 sm:w-[200px] sm:shrink-0">
          ...
          <div className="relative w-full">
            ...
            <ProviderCta
              ...
              className="flex h-[42px] w-full items-center justify-center gap-2 rounded-lg bg-[#111111] text-[15px] font-bold text-white transition-colors hover:bg-[#000000]"
            >
              Visit Site
              {arrowSvg}
            </ProviderCta>
      ...
      <div className="flex flex-col sm:hidden p-5 pt-12">
        ...
        <ProviderCta
          ...
          pageType={pageType}
          sourceFlow={sourceFlow}
          className="mt-5 flex h-[48px] w-full items-center justify-center gap-2 rounded-lg bg-[#111111] text-[16px] font-bold text-white transition-colors hover:bg-[#000000]"
        >
          Visit Site
          {arrowSvg}
        </ProviderCta>
