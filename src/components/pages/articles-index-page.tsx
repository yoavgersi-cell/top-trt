        ...
        >
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="flex flex-1 flex-col justify-center p-6 sm:p-8">
              ...
              <h2 className="text-[20px] font-bold leading-tight text-[#191919] group-hover:text-[#111111] transition-colors sm:text-[22px]">
                {articles[0].title}
              </h2>
              <p className="mt-2 text-[14px] leading-relaxed text-gray-500 line-clamp-2">
                {articles[0].description}
              </p>
              <span className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#111111]">
                Read article
          ...
          {articles.slice(1).map((article, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <h2 className="text-[16px] font-bold leading-snug text-[#191919] group-hover:text-[#111111] transition-colors">
                  {article.title}
                </h2>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {guides.map((g) => (
                ...
                >
                  ...
                  <h3 className="text-[16px] font-bold leading-snug text-[#191919] transition-colors group-hover:text-[#111111]">
                    {g.title}
                  </h3>
                  <p className="mt-2 flex-1 text-[13px] leading-relaxed text-gray-500 line-clamp-3">
                    {g.description}
              ...
              {comparisons.map(({ battle, p1, p2, winner }) => (
                ...
                >
                  ...
                  <div className="mb-5 flex items-center justify-between gap-3">
                    ...
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-[#111111]/20 bg-white text-[11px] font-extrabold text-[#111111]">
                      VS
                    </span>
                    <div className="flex h-[36px] flex-1 items-center justify-center">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                  ...
                  <h3 className="text-center text-[16px] font-bold leading-snug text-[#191919] group-hover:text-[#111111] transition-colors">
                    {p1.name} vs {p2.name}
                  </h3>
