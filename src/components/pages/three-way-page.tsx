...
// Three-way pages are not used on this single-vertical ED site (the registry is
  ...
  return (
    <div className="bg-[#FAFAFA]">
      ...
      <div className="mx-auto max-w-[1100px] px-4 pb-16 pt-10 sm:px-6">
        ...
        {/* Verdict */}
        <div className="mb-12 rounded-2xl border border-[#111111]/20 bg-white p-6 shadow-sm sm:p-8">
          <p className="mb-2.5 text-[12px] font-bold uppercase tracking-[0.07em] text-[#111111]">Our verdict</p>
